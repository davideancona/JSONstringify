...
const stringifyTrunc = require('./stringify-trunc')
...
console.assert(stringifyTrunc(o)==='{"getter":"[Getter]","r":"[Cycle]","q":"[Cycle]","p":"[Cycle]","x":42}')
...
console.assert(stringifyTrunc(o)==='["[Cycle]"]')
o.length=4
console.assert(stringifyTrunc(o)==='["[Cycle]",null,null,null]')
o[6]=1
console.assert(stringifyTrunc(o)==='["[Cycle]",null,null,null,null,null,1]')
o.prop=1
console.assert(stringifyTrunc(o)==='["[Cycle]",null,null,null,null,null,1]')
...
console.assert(stringifyTrunc(a,{depth:3})==='[{"p":"[Cycle]"},{"p":"[Cycle]","q":1},{"p":"[Cycle]","q":{"p":"[Object]","q":1}}]')
